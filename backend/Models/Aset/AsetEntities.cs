...
// Pengajuan mutasi lokasi/wilayah (kode CC) aset - overlay MURNI, TIDAK PERNAH menulis ke
// dbo.assets. LOKASI/KODE_CC/NILAI_BUKU asli di ERP tetap diubah manual oleh tim akunting
// setelah diproses/di-approve di ERP sendiri; MyGCS cuma mencatat riwayat pengajuannya.
// Lihat 17-mutasi-lokasi-ddl.sql.
public class AsetMutasi
{
    public long Id { get; set; }
    public string ObjectId { get; set; } = string.Empty;
    public string? LokasiLama { get; set; }
    public string LokasiBaru { get; set; } = string.Empty;
    public string? KodeCcLama { get; set; }
    public string? WilayahLama { get; set; }
    public string? KodeCcBaru { get; set; }
    public string? WilayahBaru { get; set; }
    public decimal? NilaiBukuSaatDiajukan { get; set; }
