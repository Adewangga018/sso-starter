...
public class InovasiDbContext : DbContext
{
    ...
    protected override void OnModelCreating(ModelBuilder b)
    {
        b.Entity<Gugus>(e =>
        {
            ...
            e.Property(x => x.BagianSeksi).HasColumnName("bagian_seksi");
            ...
            e.Property(x => x.VerifikasiStatistik).HasColumnName("verifikasi_statistik");
            e.Property(x => x.AreaLokasi).HasColumnName("area_lokasi");
            e.Property(x => x.ProfilDenahPath).HasColumnName("profil_denah_path");
            e.Property(x => x.ProfilDenahNama).HasColumnName("profil_denah_nama");
            e.Property(x => x.DampakPositif).HasColumnName("dampak_positif");
            e.Property(x => x.DampakPositifLainnya).HasColumnName("dampak_positif_lainnya");
            e.Property(x => x.LimaRJadwal).HasColumnName("lima_r_jadwal");
            e.Property(x => x.LimaRCatatan).HasColumnName("lima_r_catatan");
            e.Property(x => x.LimaRDokumentasi).HasColumnName("lima_r_dokumentasi");
